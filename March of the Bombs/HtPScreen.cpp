...
{
	HtPScreen::createBackground();
	HtPScreen::createButtons();
}
...
void HtPScreen::update(float deltaTime)
{
...
void HtPScreen::draw(Graphics::ptr graphics)
{
...
Screen::ptr HtPScreen::getNextScreen()
{
	Screen::ptr screen;
...
{
	TextureSection Background(L"images/NewBI/HtP.png");
...
void HtPScreen::MousePressEventMethod(MouseButtonEvent* mbEvent)
{
...
void HtPScreen::MouseTouchEventMethod(MouseMoveEvent* mmEvent)
{
